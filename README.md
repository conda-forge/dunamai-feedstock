...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dunamai-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12814&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dunamai-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dunamai` can be installed with:

```
conda install dunamai
```

It is possible to list all of the versions of `dunamai` available on your platform with:
